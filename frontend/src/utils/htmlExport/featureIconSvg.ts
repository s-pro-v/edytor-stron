import { resolveIconName } from "../../components/icons/iconRegistry";
...
const ICON_SVGS: Record<string, string> = {
  ...
  gem: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.5 3 8 9l4 13 4-13-2.5-6"/><path d="M7 9h10"/><path d="M3 9h4l1 12h8l1-12h4"/></svg>',
  "bar-chart-3":
...
export function renderModuleIconSvg(icon: string): string {
  const resolved = resolveIconName(icon) || "sparkles";
  return ICON_SVGS[resolved] || ICON_SVGS.sparkles;
}

/** @deprecated */
export const renderFeatureIconSvg = renderModuleIconSvg;
